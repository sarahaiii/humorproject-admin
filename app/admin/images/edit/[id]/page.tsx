    ...
    return (
        <main className="px-6 py-10">
            <div className="mx-auto max-w-3xl">
                <h1 className="mb-8 text-5xl font-bold text-white">Edit Image</h1>

                <div className="glass-card rounded-2xl p-8">
                    <div className="mb-8">
                        <p className="mb-3 text-sm uppercase tracking-[0.2em] text-indigo-200/70">
                            Current Image
                        </p>
                    ...
                    <form action={updateImage} className="space-y-6">
                        <div>
                            <label className="mb-2 block text-sm font-medium text-indigo-100">
                                Image URL
                            </label>
                            <input
                                name="url"
                                defaultValue={image.url ?? ""}
                                className="w-full rounded-xl border border-white/20 bg-transparent p-4 text-white placeholder:text-white/40"
                            />
                        </div>
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <a
                                href="/admin/images"
                                className="rounded-xl border border-white/15 px-6 py-3 text-white/90 transition hover:bg-white/5"
                            >
                                Cancel
                            </a>
                        </div>
